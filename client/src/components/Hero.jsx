...
const TypewriterEffect = ({ words }) => {
    ...
    return (
        <>
            ...
            <span className={`inline-block w-[3px] h-[0.85em] bg-[#00FF00] align-middle ml-1 rounded-full transition-opacity duration-200 ${blink ? 'opacity-100' : 'opacity-0'}`}></span>
        </>
    );
};
    ...
    return (
        <section className="relative min-h-screen pt-40 pb-20 lg:pt-48 lg:pb-32 px-6 overflow-hidden flex flex-col items-center justify-center text-center">
            ...
            <div className="absolute inset-0 z-0 bg-[var(--color-bg-dark)]">
                ...
                <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(0,255,0,0.06)_0%,transparent_60%)]"></div>
            </div>
            ...
            >
                ...
                <motion.div variants={fadeUp} className="section-label mb-8">
                    <Sparkles size={14} className="text-[#00FF00]" /> AI-Powered Learning Platform
                </motion.div>
                ...
                <motion.div variants={fadeUp} className="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="#" className="btn btn-outline w-full sm:w-auto px-8 py-4 text-base flex items-center gap-2 group">
                        <Play size={18} className="text-[#00FF00] group-hover:scale-110 transition-transform" /> Watch Demo
                    </a>
                </motion.div>
            </motion.div>
            ...
            >
                <div className="w-full aspect-[16/9] rounded-2xl border border-white/[0.06] bg-[var(--color-surface)] shadow-[0_20px_60px_rgba(0,0,0,0.5)] overflow-hidden relative">
                    ...
                    <div className="h-10 border-b border-white/[0.06] flex items-center px-4 gap-2 bg-[var(--color-bg-dark)]/80">
                        ...
                        <div className="w-3 h-3 rounded-full bg-[#00FF00]/60"></div>
                    ...
                    <div className="p-4 md:p-8 grid grid-cols-3 gap-6 h-[calc(100%-2.5rem)]">
                        <div className="col-span-2 bg-[var(--color-bg-dark)] rounded-xl border border-white/[0.06] p-6 font-mono text-sm overflow-hidden text-left relative flex flex-col justify-center">
                            ...
                            <div><span className="text-[#00FF00]">const</span><span className="text-white"> engine = </span><span className="text-[#00FF00]">new</span><span className="text-white"> EduNex();</span></div>
                            <div className="mt-2"><span className="text-[#00FF00]">await</span><span className="text-white"> engine.</span><span className="text-[#00FF00]">initialize</span><span className="text-white">({'{'}</span></div>
                            <div className="text-white ml-6 mt-1">mode: <span className="text-amber-400">'interactive'</span>,</div>
                            <div className="text-white ml-6 mt-1">ai: <span className="text-[#00FF00]">true</span>,</div>
                            ...
                            <div className="absolute bottom-6 right-6 w-2.5 h-2.5 bg-[#00FF00] rounded-full animate-pulse"></div>
                        </div>
                        <div className="col-span-1 flex flex-col gap-6">
                            <div className="flex-1 bg-[var(--color-bg-dark)] rounded-xl border border-white/[0.06] flex flex-col items-center justify-center relative overflow-hidden">
                                <div className="w-16 h-16 rounded-2xl bg-[#00FF00]/10 border border-[#00FF00]/20 flex items-center justify-center mb-3">
                ...
                <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 w-3/4 h-20 bg-[#00FF00]/10 blur-3xl rounded-full pointer-events-none"></div>
            </motion.div>
        </section>
    );
};
