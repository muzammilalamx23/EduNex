  ...
  return (
    <div className="h-screen w-screen bg-gray-50 text-gray-900 overflow-hidden flex flex-col font-body relative">
      ...
      <header className="h-16 border-b border-gray-200 bg-white flex items-center justify-between px-4 shrink-0 shadow-lg z-20">
        <div className="flex items-center gap-6">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <div>
              ...
              <p className="text-[9px] text-violet-600 uppercase tracking-widest font-black">HTML Mastery (10 Levels)</p>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-1 justify-center max-w-lg">
          <div className="flex items-center gap-2 bg-gray-50 p-1.5 rounded-2xl border border-gray-200 shadow-inner">
            ...
            <div className="flex items-center gap-2 px-4 py-1.5 bg-violet-50 text-violet-600 rounded-xl border border-violet-200">
              <Zap size={16} className="fill-violet-500" />
        ...
        <div className="flex items-center gap-3">
          <button 
            onClick={handleReset}
            className="flex items-center gap-2 text-xs font-bold px-4 py-2.5 bg-gray-50 text-gray-700 border border-gray-200 rounded-xl hover:bg-gray-100 transition-all"
          >
          ...
          <button 
            ...
            className="flex items-center gap-2 text-xs font-bold px-5 py-2.5 bg-gradient-to-r from-violet-600 to-indigo-500 text-white rounded-xl hover:scale-105 active:scale-95 transition-all shadow-[0_0_20px_rgba(124,58,237,0.3)] disabled:opacity-50 disabled:pointer-events-none"
          >
      ...
      <main className="flex-1 flex overflow-hidden">
        ...
        <section className="w-1/4 min-w-[320px] max-w-[400px] border-r border-gray-200 bg-white/80 flex flex-col relative z-10 shadow-xl">
        ...
        <section className="w-[35%] min-w-[300px] flex flex-col bg-gray-50 relative z-0">
        ...
        <section className="flex-1 bg-white relative flex flex-col shadow-[-10px_0_30px_rgba(0,0,0,0.05)] z-20">
